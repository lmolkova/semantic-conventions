...
- [Fan metrics `hw.fan.*`](#fan-metrics-hwfan)
  ...
  - [Metric: `hw.fan.speed.limit`](#metric-hwfanspeedlimit)
...
`hw.type` MUST be set to `"fan"`.

All fan metrics include the common hardware attributes listed on each metric below.

### Metric: `hw.fan.speed`

This metric is [recommended][MetricRecommended].

<!-- weaver .registry.metrics[] | select(.name == "hw.fan.speed") -->
...
| -------- | --------------- | ----------- | -------------- | --------- | ------ |
| `hw.fan.speed` | Gauge | `rpm` | Fan speed in revolutions per minute. | ![Development](https://img.shields.io/badge/-development-blue) | |
...
| [`hw.sensor_location`](/docs/registry/attributes/hw.md) | ![Development](https://img.shields.io/badge/-development-blue) | `Recommended` | string | Location of the sensor | `cpu0`; `ps1`; `INLET`; `CPU0_DIE`; `AMBIENT`; `MOTHERBOARD`; `PS0 V3_3`; `MAIN_12V`; `CPU_VCORE` |
...
<!-- weaver .registry.metrics[] | select(.name == "hw.fan.speed.limit") -->
<!-- NOTE: THIS TEXT IS AUTOGENERATED. DO NOT EDIT BY HAND. -->
<!-- see templates/registry/markdown/snippet.md.j2 -->
<!-- prettier-ignore-start -->
...
| Name | Instrument Type | Unit (UCUM) | Description | Stability | Entity Associations |
| -------- | --------------- | ----------- | -------------- | --------- | ------ |
| `hw.fan.speed.limit` | Gauge | `rpm` | Speed limit in rpm. | ![Development](https://img.shields.io/badge/-development-blue) | |
...
| --- | --- | --- | --- | --- | --- |
| [`hw.id`](/docs/registry/attributes/hw.md) | ![Development](https://img.shields.io/badge/-development-blue) | `Required` | string | An identifier for the hardware component, unique within the monitored host | `win32battery_battery_testsysa33_1` |
| [`hw.limit_type`](/docs/registry/attributes/hw.md) | ![Development](https://img.shields.io/badge/-development-blue) | `Recommended` | string | Type of limit for hardware components | `low.critical`; `low.degraded`; `max` |
| [`hw.name`](/docs/registry/attributes/hw.md) | ![Development](https://img.shields.io/badge/-development-blue) | `Recommended` | string | An easily-recognizable name for the hardware component | `eth0` |
| [`hw.parent`](/docs/registry/attributes/hw.md) | ![Development](https://img.shields.io/badge/-development-blue) | `Recommended` | string | Unique identifier of the parent component (typically the `hw.id` attribute of the enclosure, or disk controller) | `dellStorage_perc_0` |
| [`hw.sensor_location`](/docs/registry/attributes/hw.md) | ![Development](https://img.shields.io/badge/-development-blue) | `Recommended` | string | Location of the sensor | `cpu0`; `ps1`; `INLET`; `CPU0_DIE`; `AMBIENT`; `MOTHERBOARD`; `PS0 V3_3`; `MAIN_12V`; `CPU_VCORE` |
...
<!-- weaver .registry.metrics[] | select(.name == "hw.fan.speed_ratio") -->
<!-- NOTE: THIS TEXT IS AUTOGENERATED. DO NOT EDIT BY HAND. -->
<!-- see templates/registry/markdown/snippet.md.j2 -->
<!-- prettier-ignore-start -->
...
| Name | Instrument Type | Unit (UCUM) | Description | Stability | Entity Associations |
| -------- | --------------- | ----------- | -------------- | --------- | ------ |
| `hw.fan.speed_ratio` | Gauge | `1` | Fan speed expressed as a fraction of its maximum speed. | ![Development](https://img.shields.io/badge/-development-blue) | |
...
- `hw.type` MUST be set to `"fan"` to indicate that the status is for a fan.
- `hw.state` MUST be set to one of the following values to indicate the fan state:
...
<!-- weaver .refinements.metrics[] | select(.id == "hw.status.fan") -->
<!-- NOTE: THIS TEXT IS AUTOGENERATED. DO NOT EDIT BY HAND. -->
<!-- see templates/registry/markdown/snippet.md.j2 -->
<!-- prettier-ignore-start -->
