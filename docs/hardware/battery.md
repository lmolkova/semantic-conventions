...
All battery metrics include the common hardware attributes listed on each metric below.

### Metric: `hw.battery.charge`

This metric is [recommended][MetricRecommended].

<!-- weaver .registry.metrics[] | select(.name == "hw.battery.charge") -->
...
| [`hw.battery.capacity`](/docs/registry/attributes/hw.md) | ![Development](https://img.shields.io/badge/-development-blue) | `Recommended` | string | Design capacity in Watts-hours or Ampere-hours | `9.3Ah`; `50Wh` |
| [`hw.battery.chemistry`](/docs/registry/attributes/hw.md) | ![Development](https://img.shields.io/badge/-development-blue) | `Recommended` | string | Battery [chemistry](https://schemas.dmtf.org/wbem/cim-html/2.31.0/CIM_Battery.html), e.g. Lithium-Ion, Nickel-Cadmium, etc. | `Li-ion`; `NiMH` |
...
<!-- weaver .registry.metrics[] | select(.name == "hw.battery.charge.limit") -->
<!-- NOTE: THIS TEXT IS AUTOGENERATED. DO NOT EDIT BY HAND. -->
<!-- see templates/registry/markdown/snippet.md.j2 -->
<!-- prettier-ignore-start -->
...
<!-- weaver .registry.metrics[] | select(.name == "hw.battery.time_left") -->
<!-- NOTE: THIS TEXT IS AUTOGENERATED. DO NOT EDIT BY HAND. -->
<!-- see templates/registry/markdown/snippet.md.j2 -->
<!-- prettier-ignore-start -->
...
| [`hw.battery.state`](/docs/registry/attributes/hw.md) | ![Development](https://img.shields.io/badge/-development-blue) | `Conditionally Required` If the battery is charging or discharging | string | The current state of the battery [1] | `charging`; `discharging` |
| [`hw.battery.capacity`](/docs/registry/attributes/hw.md) | ![Development](https://img.shields.io/badge/-development-blue) | `Recommended` | string | Design capacity in Watts-hours or Ampere-hours | `9.3Ah`; `50Wh` |
| [`hw.battery.chemistry`](/docs/registry/attributes/hw.md) | ![Development](https://img.shields.io/badge/-development-blue) | `Recommended` | string | Battery [chemistry](https://schemas.dmtf.org/wbem/cim-html/2.31.0/CIM_Battery.html), e.g. Lithium-Ion, Nickel-Cadmium, etc. | `Li-ion`; `NiMH` |
| [`hw.model`](/docs/registry/attributes/hw.md) | ![Development](https://img.shields.io/badge/-development-blue) | `Recommended` | string | Descriptive model name of the hardware component | `PERC H740P`; `Intel(R) Core(TM) i7-10700K`; `Dell XPS 15 Battery` |
| [`hw.name`](/docs/registry/attributes/hw.md) | ![Development](https://img.shields.io/badge/-development-blue) | `Recommended` | string | An easily-recognizable name for the hardware component | `eth0` |
...
<!-- weaver .refinements.metrics[] | select(.id == "hw.status.battery") -->
<!-- NOTE: THIS TEXT IS AUTOGENERATED. DO NOT EDIT BY HAND. -->
<!-- see templates/registry/markdown/snippet.md.j2 -->
<!-- prettier-ignore-start -->
