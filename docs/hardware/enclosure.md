...
All enclosure metrics include the common hardware attributes listed on each metric below.
...
<!-- weaver .refinements.metrics[] | select(.id == "hw.status.enclosure") -->
...
| [`hw.enclosure.type`](/docs/registry/attributes/hw.md) | ![Development](https://img.shields.io/badge/-development-blue) | `Recommended` | string | Type of the enclosure (useful for modular systems) | `Computer`; `Storage`; `Switch` |
