...
All memory metrics include the common hardware attributes listed on each metric below.
...
<!-- weaver .refinements.metrics[] | select(.id == "hw.errors.memory") -->
...
| [`hw.memory.type`](/docs/registry/attributes/hw.md) | ![Development](https://img.shields.io/badge/-development-blue) | `Recommended` | string | Type of the memory module | `DDR4`; `DDR5`; `LPDDR5` |
...
<!-- weaver .registry.metrics[] | select(.name == "hw.memory.size") -->
<!-- NOTE: THIS TEXT IS AUTOGENERATED. DO NOT EDIT BY HAND. -->
<!-- see templates/registry/markdown/snippet.md.j2 -->
<!-- prettier-ignore-start -->
...
<!-- weaver .refinements.metrics[] | select(.id == "hw.status.memory") -->
<!-- NOTE: THIS TEXT IS AUTOGENERATED. DO NOT EDIT BY HAND. -->
<!-- see templates/registry/markdown/snippet.md.j2 -->
<!-- prettier-ignore-start -->
