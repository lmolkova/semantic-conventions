...
All power supply metrics include the common hardware attributes listed on each metric below.
...
<!-- weaver .registry.metrics[] | select(.name == "hw.power_supply.limit") -->
...
| [`hw.limit_type`](/docs/registry/attributes/hw.md) | ![Development](https://img.shields.io/badge/-development-blue) | `Recommended` | string | Type of limit for hardware components | `max`; `critical`; `throttled` |
...
<!-- weaver .registry.metrics[] | select(.name == "hw.power_supply.utilization") -->
<!-- NOTE: THIS TEXT IS AUTOGENERATED. DO NOT EDIT BY HAND. -->
<!-- see templates/registry/markdown/snippet.md.j2 -->
<!-- prettier-ignore-start -->
...
<!-- weaver .registry.metrics[] | select(.name == "hw.power_supply.usage") -->
<!-- NOTE: THIS TEXT IS AUTOGENERATED. DO NOT EDIT BY HAND. -->
<!-- see templates/registry/markdown/snippet.md.j2 -->
<!-- prettier-ignore-start -->
...
<!-- weaver .refinements.metrics[] | select(.id == "hw.status.power_supply") -->
<!-- NOTE: THIS TEXT IS AUTOGENERATED. DO NOT EDIT BY HAND. -->
<!-- see templates/registry/markdown/snippet.md.j2 -->
<!-- prettier-ignore-start -->
