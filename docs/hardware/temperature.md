...
All temperature metrics include the common hardware attributes listed on each metric below.
...
<!-- weaver .registry.metrics[] | select(.name == "hw.temperature") -->
...
<!-- weaver .registry.metrics[] | select(.name == "hw.temperature.limit") -->
<!-- NOTE: THIS TEXT IS AUTOGENERATED. DO NOT EDIT BY HAND. -->
<!-- see templates/registry/markdown/snippet.md.j2 -->
<!-- prettier-ignore-start -->
...
<!-- weaver .refinements.metrics[] | select(.id == "hw.status.temperature") -->
<!-- NOTE: THIS TEXT IS AUTOGENERATED. DO NOT EDIT BY HAND. -->
<!-- see templates/registry/markdown/snippet.md.j2 -->
<!-- prettier-ignore-start -->
