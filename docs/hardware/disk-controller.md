...
All disk controller metrics include the common hardware attributes listed on each metric below.
...
<!-- weaver .refinements.metrics[] | select(.id == "hw.status.disk_controller") -->
...
| [`hw.bios_version`](/docs/registry/attributes/hw.md) | ![Development](https://img.shields.io/badge/-development-blue) | `Recommended` | string | BIOS version of the hardware component | `1.2.3` |
