...
<!-- semconv event.gen_ai.operation.start -->
...
The event name MUST be `gen_ai.operation.start`.

The chat history provided to the model or agent as an input excluding the system message/instructions.

| Attribute  | Type | Description  | Examples  | [Requirement Level](https://opentelemetry.io/docs/specs/semconv/general/attribute-requirement-level/) | Stability |
|---|---|---|---|---|---|
| [`gen_ai.conversation.id`](/docs/registry/attributes/gen-ai.md) | string | The unique identifier for a conversation (session, thread), used to store and correlate messages within this conversation. | `conv_5j66UpCpwteGg4YSxUnt7lPY` | `Conditionally Required` when available | ![Development](https://img.shields.io/badge/-development-blue) |
| [`gen_ai.input.messages`](/docs/registry/attributes/gen-ai.md) | string | The chat history provided to the model or agent as an input excluding the system message/instructions. [1] | `[{"role": "user",      "parts": [{"type": "text", "content": "Weather in Paris?"}]}, {"role": "assistant", "parts": [{"type": "tool_call", "id": "call_VSPygqKTWdrhaFErNvMV18Yl", "name":"get_weather", "arguments":{"location":"Paris"}}]}, {"role": "tool",      "parts": [{"type": "tool_call_response", "id":" call_VSPygqKTWdrhaFErNvMV18Yl", "result":"rainy, 57°F"}]}]` | `Recommended` | ![Development](https://img.shields.io/badge/-development-blue) |
| [`gen_ai.input.messages_ref`](/docs/registry/attributes/gen-ai.md) | string | The link to the chat history recorded in a separate storage. [2] | `s3://acme.prod.support_bot.chats.2025/conv_1234/run_42.json` | `Recommended` | ![Development](https://img.shields.io/badge/-development-blue) |
| [`gen_ai.operation.name`](/docs/registry/attributes/gen-ai.md) | string | The name of the operation being performed. [3] | `chat`; `generate_content`; `text_completion` | `Recommended` | ![Development](https://img.shields.io/badge/-development-blue) |
...
| [`gen_ai.system`](/docs/registry/attributes/gen-ai.md) | string | The Generative AI product as identified by the client or server instrumentation. [4] | `openai` | `Recommended` | ![Development](https://img.shields.io/badge/-development-blue) |
| [`gen_ai.system.instructions`](/docs/registry/attributes/gen-ai.md) | string | The system message or instructions provided to the GenAI model or agent. [5] | `{"role": "system", "message": {"type": "text", "content": "You are a helpful assistant"}}` | `Recommended` | ![Development](https://img.shields.io/badge/-development-blue) |
| [`gen_ai.system.instructions_ref`](/docs/registry/attributes/gen-ai.md) | string | The link to the system message or instructions recorded in a separate storage. [6] | `s3://acme.prod.support_bot.chats.2025/conv_1234/invocation_42.json` | `Recommended` | ![Development](https://img.shields.io/badge/-development-blue) |

**[1] `gen_ai.input.messages`:** Messages MUST be provided in the order they were sent to the model or agent.
...
**[2] `gen_ai.input.messages_ref`:** Refer to the [Uploading content to external storage](/docs/gen-ai/gen-ai-spans.md#uploading-content-to-external-storage) section for more details.
...
**[5] `gen_ai.system.instructions`:** The format of the instructions is defined in the [JSON schema](/docs/gen-ai/gen-ai-system-instructions.json)
...
**[6] `gen_ai.system.instructions_ref`:** Refer to the [Uploading content to external storage](/docs/gen-ai/gen-ai-spans.md#uploading-content-to-external-storage) section for more details.
...
<!-- semconv event.gen_ai.operation.end -->
<!-- NOTE: THIS TEXT IS AUTOGENERATED. DO NOT EDIT BY HAND. -->
<!-- see templates/registry/markdown/snippet.md.j2 -->
<!-- prettier-ignore-start -->
<!-- markdownlint-capture -->
...
The event name MUST be `gen_ai.operation.end`.
...
| [`gen_ai.operation.name`](/docs/registry/attributes/gen-ai.md) | string | The name of the operation being performed. [2] | `chat`; `generate_content`; `text_completion` | `Recommended` | ![Development](https://img.shields.io/badge/-development-blue) |
| [`gen_ai.output.messages`](/docs/registry/attributes/gen-ai.md) | string | Messages returned by the model or agent. [3] | `[{"role":"assistant","parts":[{"type":"text","content":"The weather in Paris is currently rainy with a temperature of 57°F."}],"finish_reason":"stop"}]` | `Recommended` | ![Development](https://img.shields.io/badge/-development-blue) |
| [`gen_ai.output.messages_ref`](/docs/registry/attributes/gen-ai.md) | string | The link to the model or agent output recorded in a separate storage. [4] | `s3://acme.prod.support_bot.chats.2025/conv_1234/run_42.json` | `Recommended` | ![Development](https://img.shields.io/badge/-development-blue) |
| [`gen_ai.output.type`](/docs/registry/attributes/gen-ai.md) | string | Represents the content type requested by the client. [5] | `text`; `json`; `image` | `Recommended` | ![Development](https://img.shields.io/badge/-development-blue) |
| [`gen_ai.request.model`](/docs/registry/attributes/gen-ai.md) | string | The name of the GenAI model a request is being made to. | `gpt-4` | `Recommended` | ![Development](https://img.shields.io/badge/-development-blue) |
...
| [`gen_ai.system`](/docs/registry/attributes/gen-ai.md) | string | The Generative AI product as identified by the client or server instrumentation. [6] | `openai` | `Recommended` | ![Development](https://img.shields.io/badge/-development-blue) |
...
**[3] `gen_ai.output.messages`:** The format of the output messages is defined in the [JSON schema](/docs/gen-ai/gen-ai-output-messages.json)
...
**[4] `gen_ai.output.messages_ref`:** Refer to the [Uploading content to external storage](/docs/gen-ai/gen-ai-spans.md#uploading-content-to-external-storage) section for more details.
...
**[6] `gen_ai.system`:** The `gen_ai.system` describes a family of GenAI models with specific model identified
by `gen_ai.request.model` and `gen_ai.response.model` attributes.
