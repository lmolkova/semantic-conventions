...
| [`gen_ai.system.instructions`](/docs/registry/attributes/gen-ai.md) | any | The system message or instructions provided to the GenAI model or agent separately from the chat history. [16] | `You are an Agent that greet users, always use greetings tool to respond`; `["You are a language translator.", "Your mission is to translate text in English to French."]` | `Opt-In` | ![Development](https://img.shields.io/badge/-development-blue) |
...
**[16] `gen_ai.system.instructions`:** This attribute SHOULD be used when the corresponding provider or API
