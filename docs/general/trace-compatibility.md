...
<!-- weaver .registry.attribute_groups[] | select(.id == "opentracing") -->
...
| --- | --- | --- | --- | --- |
| [`opentracing.ref_type`](/docs/registry/attributes/opentracing.md) | ![Development](https://img.shields.io/badge/-development-blue) | string | Parent-child Reference type [1] | `child_of`; `follows_from` |
