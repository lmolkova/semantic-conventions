...
For Google Cloud Pub/Sub, spans are defined per [operation type](messaging-spans.md#operation-types).
Each Pub/Sub span extends the [common messaging attributes](messaging-spans.md#messaging-attributes)
with the Pub/Sub-specific attributes below.

### Producer spans

Pub/Sub producer instrumentations create `create` (span kind `PRODUCER`) and
`send` (span kind `PRODUCER`) spans.

<!-- weaver .registry.spans[] | select(.type == "messaging.gcp_pubsub.create.producer") -->
...
Describes a Google Cloud Pub/Sub `create` operation.
...
<!-- weaver .registry.spans[] | select(.type == "messaging.gcp_pubsub.send.producer") -->
<!-- NOTE: THIS TEXT IS AUTOGENERATED. DO NOT EDIT BY HAND. -->
<!-- see templates/registry/markdown/snippet.md.j2 -->
<!-- prettier-ignore-start -->
...
Describes a Google Cloud Pub/Sub `send` operation.
...
Pub/Sub consumer instrumentations create `receive` (pull-based, span kind `CLIENT`)
and `settle` (`ack`/`nack`/`modack`, span kind `CLIENT`) spans.

<!-- weaver .registry.spans[] | select(.type == "messaging.gcp_pubsub.receive.client") -->
<!-- NOTE: THIS TEXT IS AUTOGENERATED. DO NOT EDIT BY HAND. -->
<!-- see templates/registry/markdown/snippet.md.j2 -->
<!-- prettier-ignore-start -->
...
Describes a Google Cloud Pub/Sub `receive` operation.
...
<!-- weaver .registry.spans[] | select(.type == "messaging.gcp_pubsub.settle.client") -->
<!-- NOTE: THIS TEXT IS AUTOGENERATED. DO NOT EDIT BY HAND. -->
<!-- see templates/registry/markdown/snippet.md.j2 -->
<!-- prettier-ignore-start -->
...
Describes a Google Cloud Pub/Sub `settle` operation.
