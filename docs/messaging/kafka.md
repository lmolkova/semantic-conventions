...
For Apache Kafka, spans are defined per [operation type](messaging-spans.md#operation-types).
Each Kafka span extends the [common messaging attributes](messaging-spans.md#messaging-attributes)
with the Kafka-specific attributes below.

### Producer spans

Kafka producer instrumentations create `send` spans with span kind `PRODUCER`.

<!-- weaver .registry.spans[] | select(.type == "messaging.kafka.send.producer") -->
...
Describes an Apache Kafka `send` operation.
...
| [`messaging.kafka.message.tombstone`](/docs/registry/attributes/messaging.md) | ![Development](https://img.shields.io/badge/-development-blue) | `Conditionally Required` [11] | boolean | A boolean that is true if the message is a tombstone. | |
...
**[11] `messaging.kafka.message.tombstone`:** If value is `true`. When missing, the value is assumed to be `false`.
...
**[14] `messaging.kafka.message.key`:** If the key type is not string, it's string representation has to be supplied for the attribute. If the key has no unambiguous, canonical string form, don't include its value.
...
Kafka consumer instrumentations create `receive` (pull-based, span kind `CLIENT`),
`process` (push-based, span kind `CONSUMER`), and `settle` (span kind `CLIENT`) spans.

<!-- weaver .registry.spans[] | select(.type == "messaging.kafka.receive.client") -->
<!-- NOTE: THIS TEXT IS AUTOGENERATED. DO NOT EDIT BY HAND. -->
<!-- see templates/registry/markdown/snippet.md.j2 -->
<!-- prettier-ignore-start -->
...
Describes an Apache Kafka `receive` operation.
...
<!-- weaver .registry.spans[] | select(.type == "messaging.kafka.process.consumer") -->
<!-- NOTE: THIS TEXT IS AUTOGENERATED. DO NOT EDIT BY HAND. -->
<!-- see templates/registry/markdown/snippet.md.j2 -->
<!-- prettier-ignore-start -->
...
Describes an Apache Kafka `process` operation.
...
<!-- weaver .registry.spans[] | select(.type == "messaging.kafka.settle.client") -->
<!-- NOTE: THIS TEXT IS AUTOGENERATED. DO NOT EDIT BY HAND. -->
<!-- see templates/registry/markdown/snippet.md.j2 -->
<!-- prettier-ignore-start -->
...
Describes an Apache Kafka `settle` operation.
