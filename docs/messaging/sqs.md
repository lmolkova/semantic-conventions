...
For AWS SQS, spans are defined per [operation type](messaging-spans.md#operation-types).
Each span extends the [common messaging attributes](messaging-spans.md#messaging-attributes)
with the SQS-specific attributes below.

### Producer spans

<!-- weaver .registry.spans[] | select(.type == "messaging.aws.sqs.send.producer") -->
...
Describes an AWS SQS `send` operation.
...
<!-- weaver .registry.spans[] | select(.type == "messaging.aws.sqs.receive.client") -->
<!-- NOTE: THIS TEXT IS AUTOGENERATED. DO NOT EDIT BY HAND. -->
<!-- see templates/registry/markdown/snippet.md.j2 -->
<!-- prettier-ignore-start -->
...
Describes an AWS SQS `receive` operation.
