...
For Apache RocketMQ, spans are defined per [operation type](messaging-spans.md#operation-types).
Each RocketMQ span extends the [common messaging attributes](messaging-spans.md#messaging-attributes)
with the RocketMQ-specific attributes below.

### Producer spans

<!-- weaver .registry.spans[] | select(.type == "messaging.rocketmq.send.producer") -->
...
Describes an Apache RocketMQ `send` operation.
...
| [`messaging.rocketmq.message.delay_time_level`](/docs/registry/attributes/messaging.md) | ![Development](https://img.shields.io/badge/-development-blue) | `Conditionally Required` [12] | int | The delay time level for delay message, which determines the message delay time. | `3` |
| [`messaging.rocketmq.message.delivery_timestamp`](/docs/registry/attributes/messaging.md) | ![Development](https://img.shields.io/badge/-development-blue) | `Conditionally Required` [13] | int | The timestamp in milliseconds that the delay message is expected to be delivered to consumer. | `1665987217045` |
...
**[11] `messaging.operation.type`:** If a custom value is used, it MUST be of low cardinality.

**[12] `messaging.rocketmq.message.delay_time_level`:** If the message type is delay and delivery timestamp is not specified.

**[13] `messaging.rocketmq.message.delivery_timestamp`:** If the message type is delay and delay time level is not specified.
...
<!-- weaver .registry.spans[] | select(.type == "messaging.rocketmq.receive.client") -->
<!-- NOTE: THIS TEXT IS AUTOGENERATED. DO NOT EDIT BY HAND. -->
<!-- see templates/registry/markdown/snippet.md.j2 -->
<!-- prettier-ignore-start -->
...
Describes an Apache RocketMQ `receive` operation.
...
<!-- weaver .registry.spans[] | select(.type == "messaging.rocketmq.process.consumer") -->
<!-- NOTE: THIS TEXT IS AUTOGENERATED. DO NOT EDIT BY HAND. -->
<!-- see templates/registry/markdown/snippet.md.j2 -->
<!-- prettier-ignore-start -->
...
Describes an Apache RocketMQ `process` operation.
...
<!-- weaver .registry.spans[] | select(.type == "messaging.rocketmq.settle.client") -->
<!-- NOTE: THIS TEXT IS AUTOGENERATED. DO NOT EDIT BY HAND. -->
<!-- see templates/registry/markdown/snippet.md.j2 -->
<!-- prettier-ignore-start -->
...
Describes an Apache RocketMQ `settle` operation.
