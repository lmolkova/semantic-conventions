...
For Azure Service Bus, spans are defined per [operation type](messaging-spans.md#operation-types).

#### Producer spans

<!-- weaver .registry.spans[] | select(.type == "messaging.servicebus.send.producer") -->
...
Describes an Azure Service Bus `send` operation.
...
| [`messaging.system`](/docs/registry/attributes/messaging.md) | ![Development](https://img.shields.io/badge/-development-blue) | `Required` | string | The messaging system as identified by the client instrumentation. [2] | `activemq`; `aws.sns`; `aws_sqs` |
| [`error.type`](/docs/registry/attributes/error.md) | ![Stable](https://img.shields.io/badge/-stable-lightgreen) | `Conditionally Required` If and only if the messaging operation has failed. | string | Describes a class of error the operation ended with. [3] | `amqp:decode-error`; `KAFKA_STORAGE_ERROR`; `channel-error` |
...
| [`messaging.destination.template`](/docs/registry/attributes/messaging.md) | ![Development](https://img.shields.io/badge/-development-blue) | `Conditionally Required` [9] | string | Low cardinality representation of the messaging destination name [10] | `/customers/{customerId}` |
| [`messaging.destination.temporary`](/docs/registry/attributes/messaging.md) | ![Development](https://img.shields.io/badge/-development-blue) | `Conditionally Required` [11] | boolean | A boolean that is true if the message destination is temporary and might not exist anymore after messages are processed. | |
| [`messaging.operation.type`](/docs/registry/attributes/messaging.md) | ![Development](https://img.shields.io/badge/-development-blue) | `Conditionally Required` If applicable. | string | A string identifying the type of the messaging operation. [12] | `create`; `send`; `receive` |
| [`server.address`](/docs/registry/attributes/server.md) | ![Stable](https://img.shields.io/badge/-stable-lightgreen) | `Conditionally Required` If available. | string | Server domain name if available without reverse DNS lookup; otherwise, IP address or Unix domain socket name. [13] | `example.com`; `10.1.2.80`; `/tmp/my.sock` |
...
| [`messaging.message.body.size`](/docs/registry/attributes/messaging.md) | ![Development](https://img.shields.io/badge/-development-blue) | `Opt-In` | int | The size of the message body in bytes. [16] | `1439` |
...
**[2] `messaging.system`:** The actual messaging system may differ from the one known by the client. For example, when using Kafka client libraries to communicate with Azure Event Hubs, the `messaging.system` is set to `kafka` based on the instrumentation's best knowledge.
...
**[9] `messaging.destination.template`:** If available. Instrumentations MUST NOT use `messaging.destination.name` as template unless low-cardinality of destination name is guaranteed.
...
**[11] `messaging.destination.temporary`:** If value is `true`. When missing, the value is assumed to be `false`.

**[12] `messaging.operation.type`:** If a custom value is used, it MUST be of low cardinality.
...
<!-- weaver .registry.spans[] | select(.type == "messaging.servicebus.receive.client") -->
<!-- NOTE: THIS TEXT IS AUTOGENERATED. DO NOT EDIT BY HAND. -->
<!-- see templates/registry/markdown/snippet.md.j2 -->
<!-- prettier-ignore-start -->
...
Describes an Azure Service Bus `receive` operation.
...
| [`messaging.destination.temporary`](/docs/registry/attributes/messaging.md) | ![Development](https://img.shields.io/badge/-development-blue) | `Conditionally Required` [11] | boolean | A boolean that is true if the message destination is temporary and might not exist anymore after messages are processed. | |
| [`messaging.operation.type`](/docs/registry/attributes/messaging.md) | ![Development](https://img.shields.io/badge/-development-blue) | `Conditionally Required` If applicable. | string | A string identifying the type of the messaging operation. [12] | `create`; `send`; `receive` |
| [`messaging.servicebus.message.delivery_count`](/docs/registry/attributes/messaging.md) | ![Development](https://img.shields.io/badge/-development-blue) | `Conditionally Required` [13] | int | Number of deliveries that have been attempted for this message. | `2` |
...
**[13] `messaging.servicebus.message.delivery_count`:** If delivery count is available and is bigger than 0.
...
<!-- weaver .registry.spans[] | select(.type == "messaging.servicebus.process.consumer") -->
<!-- NOTE: THIS TEXT IS AUTOGENERATED. DO NOT EDIT BY HAND. -->
<!-- see templates/registry/markdown/snippet.md.j2 -->
<!-- prettier-ignore-start -->
...
Describes an Azure Service Bus `process` operation.
...
<!-- weaver .registry.spans[] | select(.type == "messaging.servicebus.settle.client") -->
<!-- NOTE: THIS TEXT IS AUTOGENERATED. DO NOT EDIT BY HAND. -->
<!-- see templates/registry/markdown/snippet.md.j2 -->
<!-- prettier-ignore-start -->
...
Describes an Azure Service Bus `settle` operation.
...
For Azure Event Hubs, spans are defined per [operation type](messaging-spans.md#operation-types).

#### Producer spans

<!-- weaver .registry.spans[] | select(.type == "messaging.eventhubs.send.producer") -->
<!-- NOTE: THIS TEXT IS AUTOGENERATED. DO NOT EDIT BY HAND. -->
<!-- see templates/registry/markdown/snippet.md.j2 -->
<!-- prettier-ignore-start -->
...
Describes an Azure Event Hubs `send` operation.
...
<!-- weaver .registry.spans[] | select(.type == "messaging.eventhubs.receive.client") -->
<!-- NOTE: THIS TEXT IS AUTOGENERATED. DO NOT EDIT BY HAND. -->
<!-- see templates/registry/markdown/snippet.md.j2 -->
<!-- prettier-ignore-start -->
...
Describes an Azure Event Hubs `receive` operation.
...
<!-- weaver .registry.spans[] | select(.type == "messaging.eventhubs.process.consumer") -->
<!-- NOTE: THIS TEXT IS AUTOGENERATED. DO NOT EDIT BY HAND. -->
<!-- see templates/registry/markdown/snippet.md.j2 -->
<!-- prettier-ignore-start -->
...
Describes an Azure Event Hubs `process` operation.
...
<!-- weaver .registry.spans[] | select(.type == "messaging.eventhubs.settle.client") -->
<!-- NOTE: THIS TEXT IS AUTOGENERATED. DO NOT EDIT BY HAND. -->
<!-- see templates/registry/markdown/snippet.md.j2 -->
<!-- prettier-ignore-start -->
...
Describes an Azure Event Hubs `settle` operation.
