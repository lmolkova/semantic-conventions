...
<!-- weaver .registry.entities[] | select(.type == "faas") -->
...
| --- | --- | --- | --- | --- | --- | --- |
| Description | [`faas.name`](/docs/registry/attributes/faas.md) | ![Development](https://img.shields.io/badge/-development-blue) | `Required` | string | The name of the single function that this runtime instance executes. [1] | `my-function`; `myazurefunctionapp/some-function-name` |
