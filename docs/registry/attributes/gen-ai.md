...
| <a id="gen-ai-system-instructions" href="#gen-ai-system-instructions">`gen_ai.system.instructions`</a> | any | The system message or instructions provided to the GenAI model or agent separately from the chat history. [10] | `You are an Agent that greet users, always use greetings tool to respond`; `["You are a language translator.", "Your mission is to translate text in English to French."]` | ![Development](https://img.shields.io/badge/-development-blue) |
...
**[10] `gen_ai.system.instructions`:** This attribute SHOULD be used when the corresponding provider or API
