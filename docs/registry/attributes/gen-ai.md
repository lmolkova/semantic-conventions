...
| <a id="gen-ai-system-instructions" href="#gen-ai-system-instructions">`gen_ai.system.instructions`</a> | string | The system message or instructions provided to the GenAI model or agent. [10] | `You are a helpful assistant.` | ![Development](https://img.shields.io/badge/-development-blue) |
...
| <a id="gen-ai-tool-type" href="#gen-ai-tool-type">`gen_ai.tool.type`</a> | string | Type of the tool utilized by the agent [12] | `function`; `extension`; `datastore` | ![Development](https://img.shields.io/badge/-development-blue) |
