...
HTTP spans MUST follow the overall [guidelines for span names](https://github.com/open-telemetry/opentelemetry-specification/blob/v1.58.0/specification/trace/api.md#span).
...
[Span Status](https://github.com/open-telemetry/opentelemetry-specification/blob/v1.58.0/specification/trace/api.md#set-status) MUST be left unset if HTTP status code was in the
...
<!-- weaver .refinements.spans[] | select(.id == "http.client") -->
...
<!-- weaver .refinements.spans[] | select(.id == "http.server") -->
<!-- NOTE: THIS TEXT IS AUTOGENERATED. DO NOT EDIT BY HAND. -->
<!-- see templates/registry/markdown/snippet.md.j2 -->
<!-- prettier-ignore-start -->
