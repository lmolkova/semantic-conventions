...
- [Metric: `v8js.memory.heap.space.size`](#metric-v8jsmemoryheapspacesize)
- [Metric: `v8js.memory.heap.used`](#metric-v8jsmemoryheapused)
- [Metric: `v8js.resource.active`](#metric-v8jsresourceactive)
...
<!-- weaver .registry.metrics[] | select(.name == "v8js.gc.duration") -->
...
<!-- weaver .registry.metrics[] | select(.name == "v8js.memory.heap.space.available_size") -->
<!-- NOTE: THIS TEXT IS AUTOGENERATED. DO NOT EDIT BY HAND. -->
<!-- see templates/registry/markdown/snippet.md.j2 -->
<!-- prettier-ignore-start -->
...
<!-- weaver .registry.metrics[] | select(.name == "v8js.memory.heap.space.physical_size") -->
<!-- NOTE: THIS TEXT IS AUTOGENERATED. DO NOT EDIT BY HAND. -->
<!-- see templates/registry/markdown/snippet.md.j2 -->
<!-- prettier-ignore-start -->
...
## Metric: `v8js.memory.heap.space.size`

This metric is [recommended][MetricRecommended].

<!-- weaver .registry.metrics[] | select(.name == "v8js.memory.heap.space.size") -->
<!-- NOTE: THIS TEXT IS AUTOGENERATED. DO NOT EDIT BY HAND. -->
<!-- see templates/registry/markdown/snippet.md.j2 -->
<!-- prettier-ignore-start -->
...
| Name | Instrument Type | Unit (UCUM) | Description | Stability | Entity Associations |
| -------- | --------------- | ----------- | -------------- | --------- | ------ |
| `v8js.memory.heap.space.size` | UpDownCounter | `By` | Total heap memory size pre-allocated for a heap space. [1] | ![Development](https://img.shields.io/badge/-development-blue) | |
...
<!-- weaver .registry.metrics[] | select(.name == "v8js.memory.heap.used") -->
<!-- NOTE: THIS TEXT IS AUTOGENERATED. DO NOT EDIT BY HAND. -->
<!-- see templates/registry/markdown/snippet.md.j2 -->
<!-- prettier-ignore-start -->
...
## Metric: `v8js.resource.active`

This metric is [recommended][MetricRecommended].

<!-- weaver .registry.metrics[] | select(.name == "v8js.resource.active") -->
<!-- NOTE: THIS TEXT IS AUTOGENERATED. DO NOT EDIT BY HAND. -->
<!-- see templates/registry/markdown/snippet.md.j2 -->
<!-- prettier-ignore-start -->
...
| Name | Instrument Type | Unit (UCUM) | Description | Stability | Entity Associations |
| -------- | --------------- | ----------- | -------------- | --------- | ------ |
| `v8js.resource.active` | Gauge | `{resource}` | Gauge of the active resources that are currently keeping the event loop alive. [1] | ![Development](https://img.shields.io/badge/-development-blue) | |

**[1]:** The values can be retrieved from [`process.getActiveResourcesInfo()`](https://nodejs.org/api/process.html#processgetactiveresourcesinfo)
