...
<!-- weaver .registry.metrics[] | select(.name == "cpython.gc.collections") -->
...
<!-- weaver .registry.metrics[] | select(.name == "cpython.gc.collected_objects") -->
<!-- NOTE: THIS TEXT IS AUTOGENERATED. DO NOT EDIT BY HAND. -->
<!-- see templates/registry/markdown/snippet.md.j2 -->
<!-- prettier-ignore-start -->
...
<!-- weaver .registry.metrics[] | select(.name == "cpython.gc.uncollectable_objects") -->
<!-- NOTE: THIS TEXT IS AUTOGENERATED. DO NOT EDIT BY HAND. -->
<!-- see templates/registry/markdown/snippet.md.j2 -->
<!-- prettier-ignore-start -->
