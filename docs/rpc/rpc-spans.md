...
RPC spans MUST follow the overall [guidelines for span names](https://github.com/open-telemetry/opentelemetry-specification/blob/v1.58.0/specification/trace/api.md#span).
...
<!-- weaver .refinements.spans[] | select(.id == "rpc.call.client") -->
...
<!-- weaver .refinements.spans[] | select(.id == "rpc.call.server") -->
<!-- NOTE: THIS TEXT IS AUTOGENERATED. DO NOT EDIT BY HAND. -->
<!-- see templates/registry/markdown/snippet.md.j2 -->
<!-- prettier-ignore-start -->
