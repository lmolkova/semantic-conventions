...
This metric SHOULD be specified with [`ExplicitBucketBoundaries` advisory parameter](https://opentelemetry.io/docs/specs/otel/metrics/api/#instrument-advisory-parameters) of `[ 0.001, 0.005, 0.01, 0.05, 0.1, 0.5, 1, 5, 10 ]`.
...
This metric SHOULD be specified with [`ExplicitBucketBoundaries` advisory parameter](https://opentelemetry.io/docs/specs/otel/metrics/api/#instrument-advisory-parameters) of `[1, 2, 5, 10, 20, 50, 100, 200, 500, 1000, 2000, 5000, 10000]`.
