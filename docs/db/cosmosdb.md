...
This metric SHOULD be specified with [`ExplicitBucketBoundaries` advisory parameter](https://opentelemetry.io/docs/specs/otel/metrics/api/#instrument-advisory-parameters) of `[ 1, 5, 10, 25, 50, 100, 250, 500, 1000]`.
