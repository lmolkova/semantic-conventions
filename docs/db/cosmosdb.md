...
<!-- weaver .refinements.spans[] | select(.id == "azure.cosmosdb.client") -->
...
<!-- weaver .registry.metrics[] | select(.name == "azure.cosmosdb.client.operation.request_charge") -->
<!-- NOTE: THIS TEXT IS AUTOGENERATED. DO NOT EDIT BY HAND. -->
<!-- see templates/registry/markdown/snippet.md.j2 -->
<!-- prettier-ignore-start -->
...
<!-- weaver .registry.metrics[] | select(.name == "azure.cosmosdb.client.active_instance.count") -->
<!-- NOTE: THIS TEXT IS AUTOGENERATED. DO NOT EDIT BY HAND. -->
<!-- see templates/registry/markdown/snippet.md.j2 -->
<!-- prettier-ignore-start -->
