...
public final class RpcGrpcCallServerSpan {

  private static final RpcGrpcCallServerSpan NOOP =
      new RpcGrpcCallServerSpan();
  ...
  static RpcGrpcCallServerSpan noop() {
    return NOOP;
  }

  public <T> RpcGrpcCallServerSpan setAttribute(AttributeKey<T> key, T value) {
    if (!noop) {
