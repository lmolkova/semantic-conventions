...
public final class RpcJsonrpcCallServerTracer {
  ...
  private RpcJsonrpcCallServerTracer(
  ...
  public static RpcJsonrpcCallServerTracer create(
      Tracer tracer, ConfigProvider configProvider) {
    RpcJsonrpcCallServerTracer result =
        new RpcJsonrpcCallServerTracer(tracer, configProvider);
  ...
  public RpcJsonrpcCallServerSpan start(
      String spanName,
      String rpcMethod,
    ...
    if (!isEnabled(state)) {
      return RpcJsonrpcCallServerSpan.noop();
    }
    ...
    Span span =
        tracer
            ...
            .startSpan();
    return new RpcJsonrpcCallServerSpan(
        span);
  }
