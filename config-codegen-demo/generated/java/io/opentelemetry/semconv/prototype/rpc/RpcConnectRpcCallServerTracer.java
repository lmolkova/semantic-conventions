...
public final class RpcConnectRpcCallServerTracer {
  ...
  private RpcConnectRpcCallServerTracer(
  ...
  public static RpcConnectRpcCallServerTracer create(
      Tracer tracer, ConfigProvider configProvider) {
    RpcConnectRpcCallServerTracer result =
        new RpcConnectRpcCallServerTracer(tracer, configProvider);
  ...
  public RpcConnectRpcCallServerSpan start(
      String spanName,
      String rpcMethod,
    ...
    if (!isEnabled(state)) {
      return RpcConnectRpcCallServerSpan.noop();
    }
    ...
    Span span =
        tracer
            ...
            .startSpan();
    return new RpcConnectRpcCallServerSpan(
        span,
