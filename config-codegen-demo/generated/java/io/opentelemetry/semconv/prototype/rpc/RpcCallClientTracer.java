...
public final class RpcCallClientTracer {
  ...
  public static RpcCallClientTracer create(
      Tracer tracer, ConfigProvider configProvider) {
    RpcCallClientTracer result =
        new RpcCallClientTracer(tracer, configProvider);
  ...
  public RpcCallClientSpan start(
      String spanName,
      String rpcMethod,
