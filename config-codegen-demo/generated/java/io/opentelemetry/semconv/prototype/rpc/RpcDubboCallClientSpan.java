...
public final class RpcDubboCallClientSpan {
  ...
  private static final RpcDubboCallClientSpan NOOP =
      new RpcDubboCallClientSpan();
  ...
  static RpcDubboCallClientSpan noop() {
    return NOOP;
  }

  public <T> RpcDubboCallClientSpan setAttribute(AttributeKey<T> key, T value) {
    if (!noop) {
