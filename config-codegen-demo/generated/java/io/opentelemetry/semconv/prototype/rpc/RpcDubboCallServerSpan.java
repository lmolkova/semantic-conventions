...
public final class RpcDubboCallServerSpan {

  private static final RpcDubboCallServerSpan NOOP =
      new RpcDubboCallServerSpan();
  ...
  private RpcDubboCallServerSpan() {
    this.delegate = null;
    this.noop = true;
  ...
  static RpcDubboCallServerSpan noop() {
    return NOOP;
  }

  public <T> RpcDubboCallServerSpan setAttribute(AttributeKey<T> key, T value) {
    if (!noop) {
