...
public final class RpcConnectRpcCallServerSpan {

  private static final RpcConnectRpcCallServerSpan NOOP =
      new RpcConnectRpcCallServerSpan();
  ...
  private RpcConnectRpcCallServerSpan() {
    this.delegate = null;
    this.noop = true;
  ...
  static RpcConnectRpcCallServerSpan noop() {
    return NOOP;
  }

  public <T> RpcConnectRpcCallServerSpan setAttribute(AttributeKey<T> key, T value) {
    if (!noop) {
