...
public final class RpcDubboCallServerTracer {
  ...
  private RpcDubboCallServerTracer(
  ...
  public static RpcDubboCallServerTracer create(
      Tracer tracer, ConfigProvider configProvider) {
    RpcDubboCallServerTracer result =
        new RpcDubboCallServerTracer(tracer, configProvider);
  ...
  public RpcDubboCallServerSpan start(
      String spanName,
      String rpcMethod,
    ...
    if (!isEnabled(state)) {
      return RpcDubboCallServerSpan.noop();
    }
    ...
    Span span =
        tracer
            ...
            .startSpan();
    return new RpcDubboCallServerSpan(
        span,
