...
public final class RpcGrpcCallServerTracer {
  ...
  private RpcGrpcCallServerTracer(
  ...
  public static RpcGrpcCallServerTracer create(
      Tracer tracer, ConfigProvider configProvider) {
    RpcGrpcCallServerTracer result =
        new RpcGrpcCallServerTracer(tracer, configProvider);
  ...
  public RpcGrpcCallServerSpan start(
      String spanName,
      String rpcMethod,
    ...
    if (!isEnabled(state)) {
      return RpcGrpcCallServerSpan.noop();
    }
    ...
    Span span =
        tracer
            ...
            .startSpan();
    return new RpcGrpcCallServerSpan(
        span,
