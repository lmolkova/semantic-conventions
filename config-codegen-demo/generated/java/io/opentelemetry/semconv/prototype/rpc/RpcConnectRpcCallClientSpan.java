...
public final class RpcConnectRpcCallClientSpan {

  private static final RpcConnectRpcCallClientSpan NOOP =
      new RpcConnectRpcCallClientSpan();
  ...
  private RpcConnectRpcCallClientSpan() {
    this.delegate = null;
    this.noop = true;
  ...
  static RpcConnectRpcCallClientSpan noop() {
    return NOOP;
  }

  public <T> RpcConnectRpcCallClientSpan setAttribute(AttributeKey<T> key, T value) {
    if (!noop) {
