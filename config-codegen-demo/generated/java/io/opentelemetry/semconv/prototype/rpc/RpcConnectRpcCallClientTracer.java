...
public final class RpcConnectRpcCallClientTracer {
  ...
  private RpcConnectRpcCallClientTracer(
  ...
  public static RpcConnectRpcCallClientTracer create(
      Tracer tracer, ConfigProvider configProvider) {
    RpcConnectRpcCallClientTracer result =
        new RpcConnectRpcCallClientTracer(tracer, configProvider);
  ...
  public RpcConnectRpcCallClientSpan start(
      String spanName,
      String rpcMethod,
    ...
    if (!isEnabled(state)) {
      return RpcConnectRpcCallClientSpan.noop();
    }
    ...
    Span span =
        tracer
            ...
            .startSpan();
    return new RpcConnectRpcCallClientSpan(
        span,
