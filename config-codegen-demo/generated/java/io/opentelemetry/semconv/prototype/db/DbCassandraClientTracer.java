...
public final class DbCassandraClientTracer {
  ...
  private DbCassandraClientTracer(
  ...
  public static DbCassandraClientTracer create(
      Tracer tracer, ConfigProvider configProvider) {
    DbCassandraClientTracer result =
        new DbCassandraClientTracer(tracer, configProvider);
  ...
  public DbCassandraClientSpan start(
      String spanName,
    ...
    if (!isEnabled(state)) {
      return DbCassandraClientSpan.noop();
    }
    ...
    Span span =
        tracer
            ...
            .startSpan();
    return new DbCassandraClientSpan(
        span,
