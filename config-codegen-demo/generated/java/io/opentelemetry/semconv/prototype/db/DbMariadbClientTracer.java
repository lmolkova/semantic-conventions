...
public final class DbMariadbClientTracer {
  ...
  public static DbMariadbClientTracer create(
      Tracer tracer, ConfigProvider configProvider) {
    DbMariadbClientTracer result =
        new DbMariadbClientTracer(tracer, configProvider);
  ...
  public DbMariadbClientSpan start(
      String spanName,
      String dbNamespace,
    ...
    if (!isEnabled(state)) {
      return DbMariadbClientSpan.noop();
    }
    ...
    Span span =
        tracer
            ...
            .startSpan();
    return new DbMariadbClientSpan(
        span,
