...
public final class DbHbaseClientTracer {
  ...
  public static DbHbaseClientTracer create(
      Tracer tracer, ConfigProvider configProvider) {
    DbHbaseClientTracer result =
        new DbHbaseClientTracer(tracer, configProvider);
  ...
  public DbHbaseClientSpan start(
      String spanName,
