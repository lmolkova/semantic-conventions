...
public final class DbPostgresqlClientTracer {
  ...
  private DbPostgresqlClientTracer(
  ...
  public static DbPostgresqlClientTracer create(
      Tracer tracer, ConfigProvider configProvider) {
    DbPostgresqlClientTracer result =
        new DbPostgresqlClientTracer(tracer, configProvider);
  ...
  public DbPostgresqlClientSpan start(
      String spanName,
      String dbNamespace,
    ...
    if (!isEnabled(state)) {
      return DbPostgresqlClientSpan.noop();
    }
    ...
    Span span =
        tracer
            ...
            .startSpan();
    return new DbPostgresqlClientSpan(
        span,
