...
public final class DbSqlServerClientTracer {
  ...
  private DbSqlServerClientTracer(
  ...
  public static DbSqlServerClientTracer create(
      Tracer tracer, ConfigProvider configProvider) {
    DbSqlServerClientTracer result =
        new DbSqlServerClientTracer(tracer, configProvider);
  ...
  public DbSqlServerClientSpan start(
      String spanName,
      String dbNamespace,
    ...
    if (!isEnabled(state)) {
      return DbSqlServerClientSpan.noop();
    }
    ...
    Span span =
        tracer
            ...
            .startSpan();
    return new DbSqlServerClientSpan(
        span,
