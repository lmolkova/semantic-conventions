...
public final class DbSqlServerClientSpan {

  private static final DbSqlServerClientSpan NOOP =
      new DbSqlServerClientSpan();

  private final Span delegate;
  private final boolean noop;
  private final List<String> queryParameters;

  private DbSqlServerClientSpan() {
    this.delegate = null;
    this.noop = true;
    this.queryParameters = List.of();
  }

  DbSqlServerClientSpan(
      Span delegate,
  ...
  static DbSqlServerClientSpan noop() {
    return NOOP;
  }

  public <T> DbSqlServerClientSpan setAttribute(AttributeKey<T> key, T value) {
    if (!noop) {
