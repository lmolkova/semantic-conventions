...
public final class DbMysqlClientSpan {

  private static final DbMysqlClientSpan NOOP =
      new DbMysqlClientSpan();

  private final Span delegate;
  private final boolean noop;
  private final List<String> queryParameters;

  private DbMysqlClientSpan() {
    this.delegate = null;
    this.noop = true;
  ...
  static DbMysqlClientSpan noop() {
    return NOOP;
  }

  public <T> DbMysqlClientSpan setAttribute(AttributeKey<T> key, T value) {
    if (!noop) {
