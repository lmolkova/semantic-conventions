...
public final class DbCouchdbClientTracer {
  ...
  public static DbCouchdbClientTracer create(
      Tracer tracer, ConfigProvider configProvider) {
    DbCouchdbClientTracer result =
        new DbCouchdbClientTracer(tracer, configProvider);
  ...
  public DbCouchdbClientSpan start(
      String spanName,
      String dbNamespace,
    ...
    if (!isEnabled(state)) {
      return DbCouchdbClientSpan.noop();
    }
    ...
    Span span =
        tracer
            ...
            .startSpan();
    return new DbCouchdbClientSpan(
        span);
  }
