...
public final class AzureCosmosdbClientTracer {
  ...
  private AzureCosmosdbClientTracer(
  ...
  public static AzureCosmosdbClientTracer create(
      Tracer tracer, ConfigProvider configProvider) {
    AzureCosmosdbClientTracer result =
        new AzureCosmosdbClientTracer(tracer, configProvider);
  ...
  public AzureCosmosdbClientSpan start(
      String spanName,
    ...
    if (!isEnabled(state)) {
      return AzureCosmosdbClientSpan.noop();
    }
    ...
    Span span =
        tracer
            ...
            .startSpan();
    return new AzureCosmosdbClientSpan(
        span,
