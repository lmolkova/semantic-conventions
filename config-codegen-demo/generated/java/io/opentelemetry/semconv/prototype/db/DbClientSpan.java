...
public final class DbClientSpan {
  ...
  public static void setDbResponseReturnedRows(
      Span span, Long value, DeclarativeConfigProperties config) {
    if (!Config.experimental(config, "db")) {
      return;
    }
    if (value != null) {
      span.setAttribute(DbAttributes.DB_RESPONSE_RETURNED_ROWS, value);
    }
  }
