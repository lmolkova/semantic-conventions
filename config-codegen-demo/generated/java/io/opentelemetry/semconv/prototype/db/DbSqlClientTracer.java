...
public final class DbSqlClientTracer {
  ...
  public static DbSqlClientTracer create(
      Tracer tracer, ConfigProvider configProvider) {
    DbSqlClientTracer result =
        new DbSqlClientTracer(tracer, configProvider);
