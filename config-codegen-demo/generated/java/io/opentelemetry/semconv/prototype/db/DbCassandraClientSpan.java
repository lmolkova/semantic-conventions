...
public final class DbCassandraClientSpan {

  private static final DbCassandraClientSpan NOOP =
      new DbCassandraClientSpan();

  private final Span delegate;
  private final boolean noop;
  private final List<String> queryParameters;

  private DbCassandraClientSpan() {
    this.delegate = null;
    this.noop = true;
    this.queryParameters = List.of();
  }

  DbCassandraClientSpan(
      Span delegate,
  ...
  static DbCassandraClientSpan noop() {
    return NOOP;
  }

  public <T> DbCassandraClientSpan setAttribute(AttributeKey<T> key, T value) {
    if (!noop) {
